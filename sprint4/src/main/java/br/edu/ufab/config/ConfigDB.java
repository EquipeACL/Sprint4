...
/**
 * Classe respons�vel pelas configura��es com o banco de dados.
 * 
...
public class ConfigDB {
	/**
	 * m�todo respons�vel por pegar os endere�os do nosso banco de dados
	 * @param
	 * 
	 * */
	...
	/**
	 * m�todo que vai criar um container local para fazermos o gerenciamento do nosso banco de dados
	 * @param
	 * 
	 * */
	@Bean
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws Exception {
		...
		entityManagerFactoryBean.setPackagesToScan(Autor.class.getPackage().getName());
	...
	/**
	 * m�todo que vai configurar o gerenciamento da JPA
	 * @param
	 * 
	 * */
	@Bean
